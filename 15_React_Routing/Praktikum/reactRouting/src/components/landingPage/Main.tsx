          ...
          <div className="my-auto space-y-10">
            ...
            <div className="space-x-10">
              ...
              <a
                ...
                className="text-white hover:text-[#3692bd]"
              >
                Watch Video
              </a>
            </div>
          </div>
          <img src={landingImages} alt="image" width={500} height={500} className="ml-auto" />
        </div>
      </section>
        ...
        <div className="container mx-auto space-y-10 px-10 text-center">
          ...
          <form action="#" method="post" className="flex items-center justify-center gap-x-4">
            <input
              ...
              className="w-[700px] rounded-full border-2 border-gray-300 px-4 py-2.5 outline-none focus:border-[#47B2E4]"
            />
            <a
